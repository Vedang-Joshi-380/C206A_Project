...
if("TRUE" STREQUAL "TRUE")
  set(perception_SOURCE_PREFIX /home/cc/ee106a/fa24/class/ee106a-abr/c206a_proj/lab5/src/perception)
  set(perception_DEVEL_PREFIX /home/cc/ee106a/fa24/class/ee106a-abr/c206a_proj/lab5/devel)
  ...
  set(perception_INSTALL_PREFIX /home/cc/ee106a/fa24/class/ee106a-abr/c206a_proj/lab5/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'perception' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/cc/ee106a/fa24/class/ee106a-abr/c206a_proj/lab5/src/perception/${idir}'.  ${_report}")
    endif()
